...
[**Binary to Decimal and Back Converter**](https://github.com/dharmit/Projects/blob/master/Numbers/binary_decimal.py_ - Develop a converter to convert a decimal number to binary or a binary number to its decimal equivalent.
