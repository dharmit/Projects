...
**Find Cost of Tile to Cover W x H Floor**](https://github.com/dharmit/exercies) - Calculate the total cost of tile it would take t[o cover a floor plan of width and height, using a cost entered by the user.
