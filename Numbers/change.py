...
def change(cost, payment):
    ...
    c = c - (twenty * 20)
    if c == 0:
        d = {1000:thousand, 500:five_hundred, 100:hundred, 50:fifty, 20:twenty}
        return d

    ten = c / 10
    c = c - (ten * 10)
    if c == 0:
        d = {1000:thousand, 500:five_hundred, 100:hundred, 50:fifty, 20:twenty, 10:ten}
        return d

    five = c / 5
    c = c - (five * 5)
    if c == 0:
        d = {1000:thousand, 500:five_hundred, 100:hundred, 50:fifty, 20:twenty, 10:ten, 5:five}
        return d

    two = c / 2
    c = c- (two * 2)
    d = {1000:thousand, 500:five_hundred, 100:hundred, 50:fifty, 20:twenty, 10:ten, 5:five, 2:two, 1:c}
    return d
